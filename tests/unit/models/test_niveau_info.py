...
class TestNiveauInfo(unittest.TestCase):
    ...
    def test_001_init_basic(self):
        ...
        info = NiveauInfo(type=NiveauType.DEPARTEMENTAL)
        self.assertEqual(info.type, NiveauType.DEPARTEMENTAL)
    ...
    def test_002_init_full(self):
        ...
        info = NiveauInfo(
            type=NiveauType.REGIONAL,
            division=1,
            categorie=CategorieType.SENIOR,
            raw_text="R1 Senior",
            zone_geographique="regional",
        )
        self.assertEqual(info.type, NiveauType.REGIONAL)
        self.assertEqual(info.division, 1)
        self.assertEqual(info.categorie, CategorieType.SENIOR)
    ...
    def test_004_is_elite_true(self):
        ...
        info = NiveauInfo(type=NiveauType.ELITE)
    ...
    def test_009_matches_filter_zone_only_match(self):
        ...
        info = NiveauInfo(type=NiveauType.DEPARTEMENTAL, division=1)
    ...
    def test_014_matches_filter_zone_and_division_no_division(self):
        ...
        info = NiveauInfo(type=NiveauType.DEPARTEMENTAL, division=None)
