...
from ffbb_api_client_v2.models.get_rencontres_response import GetRencontresResponse
...
class TestGetRencontresResponse(unittest.TestCase):
    ...
    def test_from_dict_nested_dicts_kept_raw(self) -> None:
    ...
    def test_from_dict_officiels_empty_when_missing(self) -> None:
