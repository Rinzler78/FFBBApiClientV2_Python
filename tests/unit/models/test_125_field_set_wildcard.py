...
class Test125FieldSetWildcard(unittest.TestCase):
    ...
    def test_001_competition_wildcard_default_depth(self) -> None:
        """Test CompetitionFields.get_wildcard() default depth is 3."""
        result = CompetitionFields.get_wildcard()
        self.assertEqual(result, ["*.*.*"])

    def test_002_competition_wildcard_custom_depth(self) -> None:
    ...
    def test_012_query_fields_manager_basic_unchanged(self) -> None:
