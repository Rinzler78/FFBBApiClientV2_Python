...
class TestGetTournoisResponse(unittest.TestCase):
    ...
    def test_field_sexe(self) -> None:
        result = GetTournoisResponse.from_dict(SAMPLE_DATA)
        assert result is not None
        self.assertEqual(result.sexe, "Mixte")

    def test_field_debut_fin(self) -> None:
        result = GetTournoisResponse.from_dict(SAMPLE_DATA)
        assert result is not None
    ...
    def test_field_organisateur(self) -> None:
        result = GetTournoisResponse.from_dict(SAMPLE_DATA)
        assert result is not None
    ...
    def test_field_tournoi_types_3x3(self) -> None:
        result = GetTournoisResponse.from_dict(SAMPLE_DATA)
        assert result is not None
    ...
    def test_field_document_flyer(self) -> None:
        result = GetTournoisResponse.from_dict(SAMPLE_DATA)
        assert result is not None
    ...
    def test_field_categorie_championnat_3x3(self) -> None:
        result = GetTournoisResponse.from_dict(SAMPLE_DATA)
        assert result is not None
    ...
    def test_tournoi_types_3x3_defaults_to_empty_list(self) -> None:
