...
class TestNiveauExtractor(unittest.TestCase):
    ...
    def test_004_extract_niveau_elite_basic(self):
        ...
        self.assertEqual(result.type, NiveauTypeEnum.ELITE)
        ...
        self.assertEqual(result.categorie, CategorieTypeEnum.SENIOR)
    ...
    def test_006_extract_niveau_national_basic(self):
        ...
        self.assertIsNotNone(result)
        self.assertEqual(result.type, NiveauTypeEnum.NATIONAL)
    ...
    def test_020_extract_niveau_categorie_u13(self):
        ...
        self.assertIsNotNone(result)
        self.assertEqual(result.categorie, CategorieTypeEnum.U13)
    ...
    def test_021_extract_niveau_categorie_u15(self):
        ...
        self.assertIsNotNone(result)
        self.assertEqual(result.categorie, CategorieTypeEnum.U15)
    ...
    def test_022_extract_niveau_categorie_u18(self):
        ...
        self.assertIsNotNone(result)
        self.assertEqual(result.categorie, CategorieTypeEnum.U18)
    ...
    def test_024_extract_niveau_categorie_seniors(self):
        ...
        self.assertIsNotNone(result)
        self.assertEqual(result.categorie, CategorieTypeEnum.SENIORS)
    ...
    def test_025_extract_niveau_categorie_veteran(self):
        ...
        self.assertIsNotNone(result)
        self.assertEqual(result.categorie, CategorieTypeEnum.VETERAN)
    ...
    def test_026_extract_niveau_categorie_veterans(self):
        ...
        self.assertIsNotNone(result)
        self.assertEqual(result.categorie, CategorieTypeEnum.VETERANS)
    ...
    def test_027_extract_niveau_categorie_v35(self):
        ...
        self.assertIsNotNone(result)
        self.assertEqual(result.categorie, CategorieTypeEnum.V35)
    ...
    def test_028_extract_niveau_categorie_minime(self):
        ...
        self.assertIsNotNone(result)
        self.assertEqual(result.categorie, CategorieTypeEnum.MINIME)
    ...
    def test_029_extract_niveau_categorie_cadet(self):
        ...
        self.assertIsNotNone(result)
        self.assertEqual(result.categorie, CategorieTypeEnum.CADET)
    ...
    def test_030_extract_niveau_categorie_poussin(self):
        ...
        self.assertIsNotNone(result)
        self.assertEqual(result.categorie, CategorieTypeEnum.POUSSIN)
    ...
    def test_031_extract_niveau_categorie_mini_poussin(self):
        ...
        self.assertIsNotNone(result)
        self.assertEqual(result.categorie, CategorieTypeEnum.MINI_POUSSIN)
...
class TestGetNiveauFromIdcompetition(unittest.TestCase):
    ...
    def test_054_extract_niveau_categorie_espoir(self):
        ...
        self.assertIsNotNone(result)
        self.assertEqual(result.categorie, CategorieTypeEnum.ESPOIR)
    ...
    def test_055_extract_niveau_categorie_benjamin(self):
        ...
        self.assertIsNotNone(result)
        self.assertEqual(result.categorie, CategorieTypeEnum.BENJAMIN)
    ...
    def test_056_extract_niveau_categorie_u7(self):
        ...
        self.assertIsNotNone(result)
        self.assertEqual(result.categorie, CategorieTypeEnum.U7)
    ...
    def test_057_extract_niveau_categorie_u20(self):
        ...
        self.assertIsNotNone(result)
        self.assertEqual(result.categorie, CategorieTypeEnum.U20)
    ...
    def test_058_extract_niveau_categorie_u21(self):
        ...
        self.assertIsNotNone(result)
        self.assertEqual(result.categorie, CategorieTypeEnum.U21)
