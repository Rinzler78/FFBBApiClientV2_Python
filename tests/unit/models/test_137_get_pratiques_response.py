...
from ffbb_api_client_v2.models.get_pratiques_response import (
...
class TestGetPratiquesResponse(unittest.TestCase):
    ...
    def test_field_titre(self) -> None:
        result = GetPratiquesResponse.from_dict(SAMPLE_DATA)
        assert result is not None
    ...
    def test_field_code(self) -> None:
        result = GetPratiquesResponse.from_dict(SAMPLE_DATA)
        assert result is not None
        self.assertEqual(result.code, "BS-IDF-2025-001")

    def test_field_adresse(self) -> None:
        result = GetPratiquesResponse.from_dict(SAMPLE_DATA)
        assert result is not None
    ...
    def test_field_latitude(self) -> None:
        result = GetPratiquesResponse.from_dict(SAMPLE_DATA)
        assert result is not None
        self.assertAlmostEqual(result.latitude, 48.8634)  # type: ignore[arg-type]

    def test_field_longitude(self) -> None:
        result = GetPratiquesResponse.from_dict(SAMPLE_DATA)
        assert result is not None
    ...
    def test_nullable_cartographie_none(self) -> None:
