...
MODELS_WITH_TYPE_CHECK = [
    ...
    (
        "ffbb_api_client_v2.meilisearch_ffbb.models.pratiques_type_class",
        "PratiquesTypeClass",
    ),
    ...
    ("ffbb_api_client_v2.meilisearch.models.federated_search_result", "FederationInfo"),
    (
    ...
    ("ffbb_api_client_v2.models.competition_id", "CompetitionID"),
    ("ffbb_api_client_v2.models.competition_id_categorie", "CompetitionIDCategorie"),
    (
        "ffbb_api_client_v2.models.competition_id_type_competition",
        "CompetitionIDTypeCompetition",
    ),
    (
        "ffbb_api_client_v2.models.competition_id_type_competition_generique",
    ...
    (
        "ffbb_api_client_v2.models.competition_origine_type_competition_generique",
    ...
    ("ffbb_api_client_v2.models.competition_ref", "CompetitionRef"),
    ...
    ("ffbb_api_client_v2.models.external_competition_id", "ExternalCompetitionID"),
    ("ffbb_api_client_v2.models.external_id", "ExternalID"),
    ("ffbb_api_client_v2.models.folder", "Folder"),
    ("ffbb_api_client_v2.models.fonction", "Fonction"),
    ("ffbb_api_client_v2.models.geo", "Geo"),
    ("ffbb_api_client_v2.models.id_engagement_equipe", "IDEngagementEquipe"),
    ("ffbb_api_client_v2.models.id_organisme_equipe", "IDOrganismeEquipe"),
    ("ffbb_api_client_v2.models.id_poule", "IDPoule"),
    ...
    ("ffbb_api_client_v2.models.niveau_class", "NiveauClass"),
    ...
    ("ffbb_api_client_v2.models.organisme_id", "OrganismeId"),
    ("ffbb_api_client_v2.models.organisme_id_pere", "OrganismeIDPere"),
    ("ffbb_api_client_v2.models.phase_engagement", "PhaseEngagement"),
    ("ffbb_api_client_v2.models.poule", "Poule"),
    ("ffbb_api_client_v2.models.purple_logo", "PurpleLogo"),
    ...
    ("ffbb_api_client_v2.models.sexe_class", "SexeClass"),
    ("ffbb_api_client_v2.models.team_engagement", "TeamEngagement"),
    ("ffbb_api_client_v2.models.tournoi_type_class", "TournoiTypeClass"),
    ...
    ("ffbb_api_client_v2.models.type_class", "TypeClass"),
    (
