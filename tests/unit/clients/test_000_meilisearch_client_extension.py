...
class Test003MeilisearchClientExtension(unittest.TestCase):
    ...
    def test_000_smart_multi_search_with_empty_queries(self):
    ...
    def test_001_smart_multi_search_with_all_possible_empty_queries(self):
        if not hasattr(self, "api_client") or self.api_client is None:
            self.skipTest("Meilisearch client not initialized - missing token")
    ...
    def test_002_recursive_smart_multi_search_with_empty_queries(self):
        if not hasattr(self, "api_client") or self.api_client is None:
            self.skipTest("Meilisearch client not initialized - missing token")
    ...
    def test_003_recursive_smart_multi_search_with_all_possible_empty_queries(self):
        if not hasattr(self, "api_client") or self.api_client is None:
            self.skipTest("Meilisearch client not initialized - missing token")
        queries = generate_queries()
    ...
    def test_004_recursive_smart_multi_search_with_known_query(self):
        if not hasattr(self, "api_client") or self.api_client is None:
            self.skipTest("Meilisearch client not initialized - missing token")
