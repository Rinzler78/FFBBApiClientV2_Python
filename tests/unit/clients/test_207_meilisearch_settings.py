...
class Test207MeilisearchSettings(unittest.TestCase):
    ...
    def test_001_get_json_failure_json_decode(self) -> None:
    ...
    def test_002_002b_get_json_returns_error_response(self) -> None:
    ...
    def test_003_002c_get_index_settings_error_response_triggers_fallback(self) -> None:
    ...
    def test_004_get_index_settings_success(self) -> None:
    ...
    def test_005_get_index_settings_fallback_to_facets(self) -> None:
    ...
    def test_006_get_index_settings_both_fail(self) -> None:
    ...
    def test_007_get_filterable_attributes(self) -> None:
    ...
    def test_008_get_filterable_attributes_none(self) -> None:
    ...
    def test_009_get_sortable_attributes(self) -> None:
    ...
    def test_010_get_sortable_attributes_none(self) -> None:
        """Test get_sortable_attributes returns None when settings unavailable."""
        with patch.object(self.client, "get_index_settings", return_value=None):
            result = self.client.get_sortable_attributes("ffbbserver_salles")
            self.assertIsNone(result)

    def test_011_discover_filterable_via_facets_empty_results(self) -> None:
    ...
    def test_012_discover_filterable_via_facets_no_distribution(self) -> None:
