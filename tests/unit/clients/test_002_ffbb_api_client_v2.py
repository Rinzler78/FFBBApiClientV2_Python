...
class Test004FfbbApiClientV2(unittest.TestCase):
    ...
    def test_001_search_organismes_with_empty_name(self):
    ...
    def test_002_search_organismes_with_largest_cities(self):
    ...
    def test_003_search_organismes_single_city(self):
    ...
    def test_004_search_rencontres_with_empty_names(self):
    ...
    def test_005_search_rencontres_with_largest_cities(self):
    ...
    def test_006_search_terrains_with_empty_names(self):
    ...
    def test_007_search_terrains_with_largest_cities(self):
    ...
    def test_008_search_competitions_with_empty_names(self):
    ...
    def test_009_search_competitions_with_largest_cities(self):
    ...
    def test_010_search_salles_with_empty_names(self):
    ...
    def test_011_search_salles_with_largest_cities(self):
    ...
    def test_012_search_tournois_with_empty_names(self):
    ...
    def test_013_search_tournois_with_largest_cities(self):
    ...
    def test_014_search_pratiques_with_empty_names(self):
    ...
    def test_015_search_pratiques_with_largest_cities(self):
