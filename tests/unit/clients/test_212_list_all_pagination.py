...
class Test212ListAllPaginationRencontres(unittest.TestCase):
    ...
    def test_001_single_page(self, mock_http):
    ...
    @patch("ffbb_api_client_v2.clients.api_ffbb_app_client.http_get_json")
    def test_002_multi_page(self, mock_http):
    ...
    @patch("ffbb_api_client_v2.clients.api_ffbb_app_client.http_get_json")
    def test_003_max_items_guard(self, mock_http):
    ...
    @patch("ffbb_api_client_v2.clients.api_ffbb_app_client.http_get_json")
    def test_004_empty_response(self, mock_http):
    ...
    @patch("ffbb_api_client_v2.clients.api_ffbb_app_client.http_get_json")
    def test_005_with_filter_and_sort(self, mock_http):
...
class Test212ListAllPaginationSalles(unittest.TestCase):
    ...
    @patch("ffbb_api_client_v2.clients.api_ffbb_app_client.http_get_json")
    def test_003_none_response(self, mock_http):
...
class Test212ListAllPaginationCommunes(unittest.TestCase):
    ...
    @patch("ffbb_api_client_v2.clients.api_ffbb_app_client.http_get_json")
    def test_002_with_search(self, mock_http):
    ...
    @patch("ffbb_api_client_v2.clients.api_ffbb_app_client.http_get_json")
    def test_003_partial_last_page(self, mock_http):
    ...
    @patch("ffbb_api_client_v2.clients.api_ffbb_app_client.http_get_json")
    def test_004_no_meta_stops_after_short_page(self, mock_http):
