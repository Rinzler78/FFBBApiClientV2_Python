...
class Test_04_FFBBAPIClientV2(unittest.TestCase):
    def setUp(self):
        ...
        self.meilisearch_ffbb_client: MeilisearchFFBBClient = MeilisearchFFBBClient(
            MEILISEARCH_PROD_FFBB_APP_BEARER_TOKEN,
            debug=True,
        )

        self.ffbb_api_client: FFBBAPIClientV2 = FFBBAPIClientV2(
            self.api_ffbb_client, self.meilisearch_ffbb_client
        )
    ...
    def test_search_organismes_with_empty_name(self):
        search_organismes_result = self.ffbb_api_client.search_organismes()
    ...
    def test_search_organismes_with_most_used_letters(self):
        search_organismes_result = self.ffbb_api_client.search_multiple_organismes(
            ["a", "e", "i", "o", "u", "y", "b", "l", "m", "s"]
        )
        self.__validate_test_search(
            search_organismes_result,
    ...
    def test_search_rencontres_with_empty_names(self):
        search_rencontres_result = self.ffbb_api_client.search_rencontres()
        self.__validate_test_search(
    ...
    def test_search_rencontres_with_most_used_letters(self):
        search_rencontres_result = self.ffbb_api_client.search_multiple_rencontres(
            ["a", "e", "i", "o", "u", "y", "b", "l", "m", "s"]
        )
        self.__validate_test_search(
            search_rencontres_result,
    ...
    def test_search_terrains_with_empty_names(self):
        search_terrains_result = self.ffbb_api_client.search_terrains()
        self.__validate_test_search(
    ...
    def test_search_terrains_with_most_used_letters(self):
        search_terrains_result = self.ffbb_api_client.search_multiple_terrains(
            ["a", "e", "i", "o", "u", "y", "b", "l", "m", "s"]
        )
        self.__validate_test_search(
            search_terrains_result,
    ...
    def test_search_competitions_with_empty_names(self):
        search_competitions_result = self.ffbb_api_client.search_competitions()
        self.__validate_test_search(
    ...
    def test_search_competitions_with_most_used_letters(self):
        search_competitions_result = self.ffbb_api_client.search_multiple_competitions(
            ["a", "e", "i", "o", "u", "y", "b", "l", "m", "s"]
        )
        self.__validate_test_search(
            search_competitions_result,
    ...
    def test_search_salles_with_empty_names(self):
        search_salles_result = self.ffbb_api_client.search_salles()
        self.__validate_test_search(
    ...
    def test_search_salles_with_most_used_letters(self):
        search_salles_result = self.ffbb_api_client.search_multiple_salles(
            ["a", "e", "i", "o", "u", "y", "b", "l", "m", "s"]
        )
        self.__validate_test_search(
            search_salles_result,
    ...
    def test_search_tournois_with_empty_names(self):
        search_tournois_result = self.ffbb_api_client.search_tournois()
        self.__validate_test_search(
    ...
    def test_search_tournois_with_most_used_letters(self):
        search_tournois_result = self.ffbb_api_client.search_multiple_tournois(
            ["a", "e", "i", "o", "u", "y", "b", "l", "m", "s"]
        )
        self.__validate_test_search(
            search_tournois_result,
    ...
    def test_search_pratiques_with_empty_names(self):
        search_pratiques_result = self.ffbb_api_client.search_pratiques()
        self.__validate_test_search(
    ...
    def test_search_pratiques_with_most_used_letters(self):
        search_pratiques_result = self.ffbb_api_client.search_multiple_pratiques(
            ["a", "e", "i", "o", "u", "y", "b", "l", "m", "s"]
        )
        self.__validate_test_search(
            search_pratiques_result,
